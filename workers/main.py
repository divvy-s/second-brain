...
Runs voice_briefing_task every 30 minutes via cron.
"""
from __future__ import annotations

from arq import cron

from workers.tasks import fetch_emails_task, voice_briefing_task


class WorkerSettings:
    functions = [fetch_emails_task, voice_briefing_task]
    cron_jobs = [
        cron(fetch_emails_task, minute={0, 10, 20, 30, 40, 50}),
        cron(voice_briefing_task, minute={0, 30}),  # every 30 minutes
    ]
